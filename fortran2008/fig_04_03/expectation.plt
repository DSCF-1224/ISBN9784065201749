...
set xzeroaxis lt black linewidth 1.000 dashtype '-'
unset yzeroaxis
unset zzeroaxis
unset x2zeroaxis
unset y2zeroaxis
...
set xlabel "the number of samples" 
...
plot 'stats.dat' binary format="%1int%3double" using 1:3 with linespoints title '<x>'   , \
     ''          binary format="%1int%3double" using 1:4 with linespoints title '<x^2>' , \
