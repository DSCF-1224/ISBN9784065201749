...
program main
    ...
    use, non_intrinsic :: jackknife_statistics_lib
    ...
    do iter_block_size = 2_int32, 100_int32

        write( write_unit, * ) &!
        &                                  iter_block_size   , &!
        &   jackknife_average ( sample(:), iter_block_size ) , &!
        &   jackknife_error   ( sample(:), iter_block_size )
