...
module metropolis_sampling_lib
    ...
    private
    public  :: exe_metropolis_sampling
    ...
    subroutine exe_metropolis_sampling(action, prng_seed, initial_sample, num_samples_required, step_size, step_center, acceptance_rate, generated_samples)
    ...
    end subroutine exe_metropolis_sampling

end module metropolis_sampling_lib
