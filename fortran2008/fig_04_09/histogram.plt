...
set xrange [ -7.00000 : 7.00000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback
set ylabel "relative frequency" 
set ylabel  font "" textcolor lt -1 rotate
set y2label "" 
set y2label  font "" textcolor lt -1 rotate
set yrange [ 0.00000 : 0.500000 ] noreverse nowriteback
...
target_pdf(x) = ( exp( - 0.5 * (x + 3.0) ** 2 ) + exp( - 0.5 * (x - 3.0) ** 2 ) ) / ( 2.0 * sqrt(2.0 * pi) )
GNUTERM = "qt"
I = {0.0, 1.0}
VoxelDistance = 0.0
my_binwidth = 0.1
...
do for [iter_step_size=1:(|list_step_size|)] {
    ...
    plot for [iter=3:7:2] \
        ...
        bins binrange[-7:7] binwidth=my_binwidth \
        with histeps \
